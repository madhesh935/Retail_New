...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-col space-y-1 p-3.5 border-b border-slate-100", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-xs font-bold uppercase tracking-wider text-slate-900 font-sans flex items-center gap-2",
      className
    )}
    {...props}
  />
