    ...
    <div className="rounded-lg bg-gradient-to-r from-amber-950/95 via-[#1C1608]/95 to-amber-950/95 backdrop-blur-md border border-amber-500/60 shadow-2xl p-3 select-none flex flex-col gap-2 z-20 font-mono">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="p-1 rounded-md bg-amber-100 text-amber-800 border border-amber-200 shadow-2xs">
          ...
          <div>
            ...
            <span className="text-[10px] text-amber-700 ml-2 hidden sm:inline">
        ...
        <div className="px-2.5 py-1 rounded-md bg-white border border-amber-200 text-amber-800 font-bold text-xs tracking-wider shadow-2xs">
          {formattedTime}
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        <span className="text-[10px] text-slate-500 font-medium">17:00</span>
        ...
        <span className="text-[10px] text-slate-500 font-medium">20:00</span>
      </div>
      ...
      <div className="flex items-center justify-between pt-1 text-xs">
        <div className="flex items-center gap-2">
          <Button
            ...
            className="border-amber-200 bg-amber-500 text-white hover:bg-amber-600 gap-1.5 h-7 px-3 font-bold shadow-2xs"
          >
            {isPlaying ? (
              <>
          ...
          <Button
            ...
            size="xs"
            onClick={() => onSeek(0)}
            className="text-slate-600 hover:text-slate-900 h-7 text-[11px] font-semibold"
        ...
        <div className="flex items-center gap-1 text-[10px] font-sans">
          <span className="text-slate-500 mr-1 hidden sm:inline font-medium">Speed:</span>
          {[1, 2, 4].map((speed) => (
            <button
              key={speed}
              onClick={() => onChangeSpeed(speed)}
              className={`px-2 py-0.5 rounded-md border transition-colors cursor-pointer shadow-2xs font-bold ${
                replaySpeed === speed
