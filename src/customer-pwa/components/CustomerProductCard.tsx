    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm hover:shadow-sm transition-all text-slate-800 space-y-2.5">
      ...
      <div className="flex items-center gap-2 p-2 rounded-xl bg-slate-50 border border-slate-100 text-xs">
        ...
        <div className="flex-1 flex items-center justify-between min-w-0">
          <span className="text-slate-600 font-medium text-[11px]">Location in Store:</span>
      ...
      {/* Action Buttons: Navigate | Add to List (or In List) | Alternatives */}
      <div className="flex items-center justify-between gap-1.5 pt-1 flex-wrap">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="bg-cyan-600 hover:bg-cyan-700 active:bg-cyan-800 text-white text-xs h-8.5 px-3.5 rounded-xl gap-1.5 font-bold shadow-sm cursor-pointer flex items-center transition-all"
          >
          ...
          <button
            ...
            className={`text-xs h-8.5 px-3.5 rounded-xl gap-1.5 font-bold transition-all cursor-pointer flex items-center ${
              isInList
                ? 'bg-emerald-50 hover:bg-emerald-100 border border-emerald-300 text-emerald-800 shadow-2xs'
                : 'bg-white hover:bg-cyan-50 border border-cyan-600 text-cyan-700 shadow-2xs'
            }`}
          >
            {isInList ? (
              <>
